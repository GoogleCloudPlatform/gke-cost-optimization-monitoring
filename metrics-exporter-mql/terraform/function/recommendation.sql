...
INSERT 
INTO
  `maxlip-vparecs-24sc.gke_optimization.vpa_recs_export`
    (
...
WITH hpa_workloads AS (
  ...
  namespace_name,
  1 as flag
  FROM `maxlip-vparecs-24sc.gke_optimization.mql_export`
...
FROM `maxlip-vparecs-24sc.gke_optimization.mql_export` c
 LEFT JOIN
    hpa_workloads
  ON
