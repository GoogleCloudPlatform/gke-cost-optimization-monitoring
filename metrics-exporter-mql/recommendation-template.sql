...
CAST(cpu_usage_time.value  as INT64) as CPU_usage_time,
...
JOIN memory_request_bytes ON cpu_request_cores.Controller_name = memory_request_bytes.Controller_name AND cpu_request_cores.Project_id = memory_request_bytes.Project_id AND cpu_request_cores.Cluster_name = memory_request_bytes.Cluster_name
