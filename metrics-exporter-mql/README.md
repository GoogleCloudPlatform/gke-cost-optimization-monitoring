...
<p id="gdcalert2" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Cleaning up"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert3">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
```
    {%
       include "cloud/_docwidgets/_github_include.html" with
       project="gke-cost-optimization-monitoring"
       account="aburhan"
       file="metrics-exporter-mql/recommendation-template.sql#L50-L60"
       region_tag=""
    %}
```
...
```
    {%
       ...
       project="gke-cost-optimization-monitoring"
       account="aburhan"
       file="metrics-exporter-mql/recommendation-template.sql#L65-L93"
       region_tag=""
    %}
```
...
{%
   ...
   project="gke-cost-optimization-monitoring"
   account="aburhan"
   file="metrics-exporter-mql/recommendation-template.sql#L126-L137"
   region_tag=""
%}
```
...
{%
   ...
   project="gke-cost-optimization-monitoring"
   account="aburhan"
   file="metrics-exporter-mql/recommendation-template.sql#L150-L157"
   region_tag=""
%}
```
...
{%
   ...
   project="gke-cost-optimization-monitoring"
   account="aburhan"
   file="metrics-exporter-mql/recommendation-template.sql#L168"
   region_tag=""
%}
```
...
1. Open the [VPA container recommendations dashboard template](https://datastudio.google.com/s/iGPE32IjSjg/preview)
